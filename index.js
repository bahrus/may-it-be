        ...
        case '-html':
            {
                ...
                if (beDefinitiveProps.scriptPath !== undefined) {
                    beExportable = html `
<script data-version=0.0.10 id="be-exportable/be-exportable.js" data-when=be-importing ></script>`;
...
<${beDefinitiveProps.config.tagName} t-a-i-l-b ${{
    ...
    <template shadowroot="open">
        <template be-active>
            <script data-version=0.0.15 id="be-importing/be-importing.js"></script>
            <script data-version=0.0.31 id="be-definitive/be-definitive.js" data-when=be-importing></script>${beExportable}
...
<script type=module>
    if(customElements.get('be-active') === undefined){
        import('be-active/be-active.js').catch(err => {
            import('https://esm.run/be-active@0.0.18/be-active.js');
        });
    }
</script>
`;
