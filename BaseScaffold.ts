...
<template be-active>
    <script data-version=0.0.47 id=be-loaded/be-loaded.js data-when=be-importing ></script>
    <script data-version=0.0.94 id=be-observant/be-observant.js data-when=be-loaded ></script>
    <script data-version=0.0.51 id=be-noticed/be-noticed.js data-when=be-observant ></script>
</template>
<be-hive></be-hive>
`;
    }
